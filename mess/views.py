...
def signin(request):
    ...
    if request.method == "POST":
        ...
        if user is not None:
            ...
            info = {'roll_num': user.roll_num, 'name': str(user.Firstname), 'name2': str(
                user.Lastname), 'mail': user.Email, 'number': user.Number, 'address': user.Address}
...
def accesscoupon(request):
    ...
    if (Coupon.objects.filter(Student=u).exists()):
        ...
        coupons = [{'Date': '-', 'Breakfast': '-',
                    'Lunch': '-', 'Evening_snacks': '-', 'Dinner': '-'}]
...
def buycoupon(request):
    ...
    try:
        ...
        u = Student.objects.get(roll_num=request.user.id)
        en = Coupon(Student=u, Breakfast=n1, Lunch=n2,
                    Evening_snacks=n3, Dinner=n4, Date=n5)
        en.save()
    except:
        pass
...
def complaintstatus(request):
    ...
    if(ComplaintRecord.objects.filter(Student=u).exists()):
        ...
        complaints = [{'Complaint_ID': '-', 'Subject': '-',
...
def menumon(request):
    ...
    worksheet = wb['Sheet1']
    list = {'Day': worksheet["A2"].value, 'Breakfast': worksheet["B2"].value, 'Lunch': worksheet["C2"].value,
            'Evening_snacks': worksheet["D2"].value, 'Dinner': worksheet["E2"].value}
    print(list)
...
def menutue(request):
    wb = openpyxl.load_workbook('media/mess_menu/Mess_Menu.xlsx')
    worksheet = wb['Sheet1']
    list = {'Day': worksheet["A3"].value, 'Breakfast': worksheet["B3"].value, 'Lunch': worksheet["C3"].value,
            'Evening_snacks': worksheet["D3"].value, 'Dinner': worksheet["E3"].value}
...
def menuwed(request):
    wb = openpyxl.load_workbook('media/mess_menu/Mess_Menu.xlsx')
    worksheet = wb['Sheet1']
    list = {'Day': worksheet["A4"].value, 'Breakfast': worksheet["B4"].value, 'Lunch': worksheet["C4"].value,
            'Evening_snacks': worksheet["D4"].value, 'Dinner': worksheet["E4"].value}
...
def menuthu(request):
    wb = openpyxl.load_workbook('media/mess_menu/Mess_Menu.xlsx')
    worksheet = wb['Sheet1']
    list = {'Day': worksheet["A5"].value, 'Breakfast': worksheet["B5"].value, 'Lunch': worksheet["C5"].value,
            'Evening_snacks': worksheet["D5"].value, 'Dinner': worksheet["E5"].value}
...
def menufri(request):
    wb = openpyxl.load_workbook('media/mess_menu/Mess_Menu.xlsx')
    worksheet = wb['Sheet1']
    list = {'Day': worksheet["A6"].value, 'Breakfast': worksheet["B6"].value, 'Lunch': worksheet["C6"].value,
            'Evening_snacks': worksheet["D6"].value, 'Dinner': worksheet["E6"].value}
...
def menusat(request):
    wb = openpyxl.load_workbook('media/mess_menu/Mess_Menu.xlsx')
    worksheet = wb['Sheet1']
    list = {'Day': worksheet["A7"].value, 'Breakfast': worksheet["B7"].value, 'Lunch': worksheet["C7"].value,
            'Evening_snacks': worksheet["D7"].value, 'Dinner': worksheet["E7"].value}
...
def menusun(request):
    wb = openpyxl.load_workbook('media/mess_menu/Mess_Menu.xlsx')
    worksheet = wb['Sheet1']
    list = {'Day': worksheet["A8"].value, 'Breakfast': worksheet["B8"].value, 'Lunch': worksheet["C8"].value,
            'Evening_snacks': worksheet["D8"].value, 'Dinner': worksheet["E8"].value}
...
def registercomplaint(request):
    ...
    if request.method == 'POST':
        ...
        en.save()
        messages.success(request, 'complaint regised successfully')
